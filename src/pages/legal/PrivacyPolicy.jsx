...
const PrivacyPolicy = () => {
  return (
	<>
	  <Helmet>
		<title>Privacy Policy - Text Tarot</title>
		<meta
		  name="description"
		  content="Understand how Text Tarot collects, uses, and protects your personal information in our Privacy Policy."
		/>
	  </Helmet>
	  <div className="prose lg:prose-xl mx-auto p-4 md:p-8">
		...
		<ul>
		  ...
		  <li>Request deletion of your personal information by contacting us at <a href="mailto:support@text-tarot.com" className="text-blue-500 hover:underline">support@text-tarot.com</a>.</li>
